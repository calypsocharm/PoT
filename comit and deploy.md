...
Run in the `botcashscan` directory:
...
When you are ready to apply changes you made on your local machine, run the following commands in the `botcashscan` directory using your Terminal/PowerShell:
